 ...
 * 主要扩展了getDefaultConstructor方法 如果类没有默认构造方法则通过ReflectionFactory#newConstructorForSerialization方法为其添加默认构造方法
 */
public class DeserializeBeanInfoEx {
    ...
    public DeserializeBeanInfoEx(Class<?> clazz) {
        super();
        this.clazz = clazz;
    }
    ...
    public static Constructor<?> getDefaultConstructor(Class<?> clazz) {
        ...
        //added a default constructor dynamic
        if (defaultConstructor == null) {
            try {
                ReflectionFactory factory = ReflectionFactory.getReflectionFactory();
                defaultConstructor = factory.newConstructorForSerialization(clazz, Object.class.getDeclaredConstructor());
